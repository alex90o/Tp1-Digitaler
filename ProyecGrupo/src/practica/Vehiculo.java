...
public class Vehiculo implements ObjetoInerte, Actor {
	...
	@Override
	public String informarTipoInertee() {
		return "El vehivulo es ---> "+Vehiculo.INERTEARTIFICIAL;
	}
	...
	public void acuparAsiento() {
		if(this.disponibilidad()) {
			this.asientosOcupados ++;
			this.asientosDisponibles --;
		}else {
			System.out.println("No Posee Mas asiento Disponibles");
		}
	...
	public void desocuparAsiento() {
		if(this.asientosOcupados > 0 ) {
			...
			System.out.println("tiene todos los asiento Disponibles");
		}
